...
class CPU:
    ...
    # Instruction handlers that set pc directly
    ...
    def handle_IRET(self):
        ...
        self.reg[SP] += 1
        self.ie = True  # re-enable interrupts
    ...
    def check_interrupts(self):
        ...
        for i in range(8):
            ...
            if interrupt_happened:
                ...
                self.reg[IS] = 0  # clear IS register
                ...
                for i in range(0, 7):  # push R0 - R6 onto stack
                    self.reg[SP] -= 1
                    self.ram_write(self.reg[SP], self.reg[i])

                self.pc = self.ram[0xf8]  # set PC to handler address
    ...
    def run(self):
        ...
        while self.running:
            ...
            # Check if interrupter flag is enabled
            # then check for interrupts
            if self.ie:
                self.check_interrupts()

            # Check time for interrupt
            # After 1 second, set IS register and restart clock
